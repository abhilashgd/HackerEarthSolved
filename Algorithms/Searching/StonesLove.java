...
public class StonesLove {
	 ...
	 private void solve() {
		 ...
		 for(int i=1;i<=N;i++){sum+=nextInt();map.put(sum, i);}
		 while(Q-->0){
			 sb.append(map.ceilingEntry(nextLong()).getValue()+"\n");
		 }
		 pw.println(sb.toString());
		}

	  public static void main(String[] args) throws Exception { new StonesLove().run(); }
