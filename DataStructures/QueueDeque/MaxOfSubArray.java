...
import java.util.Iterator;
 ...
 public class MaxOfSubArray {
	 ...
	 private void solve() throws IOException {
		 ...
		 sb.append(max+" ");
		 for(int i=K;i<N;i++){
			 long firstElement=list.pollFirst();
			 long num = nextLong();
			 list.addLast(num);
			 if(num>max){
				 max=num;
	  ...
	  private long getMax(ArrayDeque<Long> list) {
		  long max=list.getFirst(),temp;
	...
	public static void main(String[] args) throws Exception { new MaxOfSubArray().run(); }
